...
/**
 * Bundle all of the components for a {@link Converter}, including the
 * {@link Mapper}.  This allows the {@link Converter} to directly access
 * the mapper as part of the Xstream context}.
 */
public class DelegateObjectXmlConverter implements Converter {
  ...
  /**
   * Provide a converter that expects access to the {@link Mapper}.
   *
   * @param delegate bundled {@link XstreamObjectConverter}
